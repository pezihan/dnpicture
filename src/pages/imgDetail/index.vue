    ...
    <view>
        ...
        <view class="user_rank">
            ...
            <view class="user_collect">
                <text class="iconfont icon-icon-test">收藏</text>
            </view>
        </view>
        <!-- 点赞 结束 -->
            ...
            <view class="comment_list">
                <view class="comment_item" v-for="item in hot" :key="item.id">
                    ...
                    <view class="comment_user">
                        <!-- 用户头像 -->
                        <view class="user_icon"><image :src="item.user.avatar" mode="widthFix" /></view>
                        <!-- 用户的名称 -->
                        ...
                        <view class="user_badge">
                            <image :src="item2.icon" mode="" v-for="item2 in item.user.title" :key="item2.icon"/>
                        </view>
                    </view>
                    <!-- 评论数据 -->
    ...
    methods: {
        ...
        getComments(id) {
            this.request({
                ...
                // 给 hot 数组中的对象中添加一个时间属性  《xxx月前》
                result.res.hot.forEach(v => v.cnTime = monent(v.atime * 1000).fromNow())
                result.res.comment.forEach(v => v.cnTime = monent(v.atime * 1000).fromNow())
        ...
        // 点击下载图片  async await  promise回调代码解决方案
